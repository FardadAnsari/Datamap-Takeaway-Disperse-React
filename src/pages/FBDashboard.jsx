  ...
  useEffect(() => {
    instanceF
      ...
      .then((response) => {
        ...
        console.log(response.data);
        console.log(response.data.attachments.data.media.media_type);
      })
      .catch((error) => {
        console.log(error);
        setError("Failed to load page info. Please try again later.");
    ...
    <div className="h-screen p-4 grid grid-cols-1 lg:grid-cols-3 gap-4">
      <div className="flex flex-col gap-4 h-full">
        ...
        <div className="h-fit border rounded-2xl p-4 shadow">
          <div className="text-md text-gray-700 space-y-2">
            <span className="font-semibold mb-1">Shop Info:</span>
      ...
      <div className="h-fit flex flex-col gap-4">
        ...
        <div className="border rounded-2xl p-4 shadow">
          <h3 className="font-semibold text-gray-700 mb-2">Page Impression</h3>
          <div className="border rounded-lg p-2 mb-4">
            <p className="text-orange-500 font-bold">Total Impression 10K</p>
            <p className="text-sm text-gray-600">Paid Impression: 6K</p>
            <p className="text-sm text-gray-600">Unique Impression: 600</p>
          </div>
