...
const ShopPopup = ({ marker, user }) => {
  // Get the correct icon based on company name
  const IconComponent =
    companyIcons[marker.properties.company.replace(/\s+/g, "").toLowerCase()];
  ...
  return (
    <div className="flex flex-col w-96 py-2 gap-2 pr-4">
      ...
      {marker.properties.company.toLowerCase() === "google business" &&
